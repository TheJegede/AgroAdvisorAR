  ...
  return (
    <main className="relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden bg-[#06130e] px-4 py-8 dark:bg-hc-bg">
      ...
      <div className="relative z-10 flex w-full flex-1 items-center justify-center">
        <div className="relative w-full max-w-md overflow-hidden rounded-[1.35rem] border border-white/25 bg-slate-950/30 p-7 shadow-[0_30px_90px_rgba(0,0,0,0.42),inset_0_1px_0_rgba(255,255,255,0.25)] backdrop-blur-2xl dark:border-2 dark:border-hc-border dark:bg-hc-surface dark:shadow-none sm:p-8">
