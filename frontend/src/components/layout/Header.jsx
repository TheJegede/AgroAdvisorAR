...
export default function Header({ onMenuClick }) {
  ...
  return (
    <header className="h-14 bg-white border-b border-gray-200 flex items-center px-4 gap-3 flex-shrink-0">
      ...
      <button
        className="md:hidden flex items-center justify-center w-9 h-9 rounded-lg hover:bg-gray-100 transition-colors text-charcoal"
        onClick={onMenuClick}
      ...
      <h1 className="font-bold text-lg text-charcoal flex-1">{t.appName}</h1>
